...
void field_model_vertices_scale()
{
    ...
    int flags = 0;
    int v1 = ff8_externals.dword_1CA92E4[0] >> 1;
    ff8_externals.dword_1CA8A50[0] = ff8_externals.dword_1CA8A50[3];
    double v30 = (double)ff8_externals.dword_1CA92E4[0]; // Float in the original implementation
    ...
    double v16 = v11 * (double)*(int16_t *)(ff8_externals.dword_1CA92E4 + 2) * 65536.0 + (double)*(int32_t *)(ff8_externals.dword_1CA92E4 + 8);
    ...
    ff8_externals.dword_1CA8A70[0] = int(round(v16));
    ff8_externals.dword_1CA8A30[0] = v17;
    ff8_externals.dword_1CA8A70[1] = x_related;
    if (x_related >= -32768) {
        if (x_related <= 0x7FFF) {
    ...
    ff8_externals.dword_1CA8A70[2] = y_related;
    if (y_related >= -32768) {
        if (y_related <= 0x7FFF) {
    ...
    ff8_externals.dword_1CA8A70[3] = z_related;
    if (z_related >= -32768) {
        if (z_related <= 0x7FFF) {
...
void field_sub_534AF0(int a1, int a2, int **a3)
{
    next_field_model_divisor = get_model_divisor(uint32_t(*a3));

    ((void(*)(int,int,int**))ff8_externals.sub_534AF0)(a1, a2, a3);
...
void ff8_remaster_init()
{
    ...
    replace_call(ff8_externals.sub_533CD0 + 0x28E, field_sub_534AF0);
    ...
    if (!extended_memory) {
        ffnx_error("%s: cannot allocate 16MB of extended memory\n", __func__);
        exit(1);
    }
    ...
    snprintf(fullpath, sizeof(fullpath), "%s/main.zzz", app_path.c_str());
    ...
    snprintf(fullpath, sizeof(fullpath), "%s/other.zzz", app_path.c_str());
