...
void ff8_battle_upload_texture(int16_t *pos_and_size, uint8_t *texture_buffer)
{
	int index = battle_get_texture_header_index(texture_buffer);
...
void vram_init()
{
	...
	replace_call(ff8_externals.battle_upload_texture_to_vram + 0x2E, ff8_battle_upload_texture);
