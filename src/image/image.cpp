...
bimg::ImageContainer *loadPng(bx::AllocatorI *allocator, bx::ReaderSeekerI *reader, bimg::TextureFormat::Enum targetFormat)
{
    ...
    bimg::ImageContainer *image = bimg::imageAlloc(allocator, targetFormat == bimg::TextureFormat::Count ? bimg::TextureFormat::RGBA8 : targetFormat, _width, _height, bit_depth, 1, false, false);
